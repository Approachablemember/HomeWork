import React, {ChangeEvent, FocusEventHandler, KeyboardEvent, MouseEventHandler, ReactNode} from 'react'
...
const Greeting: React.FC<GreetingPropsType> = (
    ...
    const inputClass = name.length === 0 ?  s.errorInput : s.input// need to fix with (?:)
